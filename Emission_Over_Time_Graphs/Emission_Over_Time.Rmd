...
CH4_2021_graph <- 
  ...
  scale_y_continuous(limits = c(-1500, 14000), 
                     expand = c(0, 0),
  ...
  annotate("point", x = as.POSIXct(c("2021-05-13",
                                       "2021-11-23")), y = -1000, shape = 25, color = "#017d35", fill ="#017d35", stroke= 1.1,size = 1)+
    annotate("point", x = as.POSIXct(c("2021-09-05", 
                                       "2022-02-04")), y = -1000, shape = 25, color = "#017d35", stroke= 1.1,fill ="#017d35",size = 1)+
  annotate(
  "text",
...
N2O_2021_graph <- 
  ...
  geom_vline(xintercept = as.POSIXct(c("2021-10-12")), linetype = "dashed", color = "black", size =0.4)+
  annotate("point", x = as.POSIXct(c("2021-05-13",
                                       "2021-11-23")), y = -170, shape = 25, color = "#017d35", fill ="#017d35", stroke= 1.1,size = 1)+
    annotate("point", x = as.POSIXct(c("2021-09-05", 
                                       "2022-02-04")), y = -170, shape = 25, color = "#017d35", fill ="#017d35",stroke= 1.1,size = 1)+
  annotate(
  "text",
  x = as.POSIXct(c("2021-07-15")),  # X-axis positions for annotations
...
CH4_2022_graph <- 
  ...
  annotate("point", x = as.POSIXct(c("2022-05-21",
                                       "2022-12-20")), y = -1000, shape = 25, color = "#017d35", fill ="#017d35", stroke= 1.1,size = 1)+
    annotate("point", x = as.POSIXct(c("2022-09-16", 
                                       "2023-02-09")), y = -1000, shape = 25, color = "#017d35", fill ="#017d35",stroke= 1.1,size = 1)+
  annotate(
  "text",
...
N2O_2022_graph <- 
  ...
  geom_vline(xintercept = as.POSIXct(c("2022-10-20")), linetype = "dashed", color = "black", size =0.4)+
  annotate("point", x = as.POSIXct(c("2022-05-21",
                                       "2022-12-20")), y = -170, shape = 25, color = "#017d35", fill ="#017d35", stroke= 1.1,size = 1)+
    annotate("point", x = as.POSIXct(c("2022-09-16", 
                                       "2023-02-09")), y = -170, shape = 25, color = "#017d35",fill ="#017d35", stroke= 1.1,size = 1)+
  annotate(
  "text",
  x = as.POSIXct(c("2022-07-15")),  # X-axis positions for annotations
  y = c(400),  # Y-axis positions for annotations
...
CH4_2023_graph <- 
  ...
  annotate("point", x = as.POSIXct(c("2023-05-26")), y = -1000, shape = 25, color = "#017d35", fill ="#017d35", stroke= 1.1,size = 1)+
    annotate("point", x = as.POSIXct(c("2023-09-11")), y = -1000, shape = 25, color = "#017d35", fill ="#017d35",stroke= 1.1,size = 1)+
  annotate(
  "text",
...
N2O_2023_graph <- 
  ...
  theme(legend.title = element_blank(),
        axis.text.x = element_text(size=10,angle=50, hjust=1.2, vjust=1.2))+
  geom_vline(xintercept = as.POSIXct(c("2023-10-20")), linetype = "dashed", color = "black", size =0.4)+
  annotate("point", x = as.POSIXct(c("2023-05-26")), y = -170, shape = 25, color = "#017d35", fill ="#017d35", stroke= 1.1,size = 1)+
    annotate("point", x = as.POSIXct(c("2023-09-11")), y = -170, shape = 25, color = "#017d35", fill ="#017d35",stroke= 1.1,size = 1)+
  annotate(
  "text",
  x = as.POSIXct(c("2023-07-15")),  # X-axis positions for annotations
  y = c(400),  # Y-axis positions for annotations
